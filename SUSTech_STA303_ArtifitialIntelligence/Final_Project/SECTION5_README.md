...
```bash
python scripts/section5_collect_dataset.py --env_id CartPole-v1 --ckpt models/cartpole_sac_2.torch --out datasets/section5/cartpole_d_expert.pt --steps 50000 --prand 0.0
...
```bash
python scripts/section5_train_bc.py   --dataset datasets/section5/cartpole_d_expert.pt --env_id CartPole-v1
python scripts/section5_train_awbc.py --dataset datasets/section5/cartpole_d_expert.pt --env_id CartPole-v1 --beta 2.0 --w_clip 20
...
```bash
python scripts/section5_eval_ood.py --bc_ckpt runs/section5/bc/cartpole_d_expert/bc_policy.pt \
    --awbc_ckpt runs/section5/awbc/cartpole_d_expert/awbc_policy.pt \
